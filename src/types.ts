...
export interface Config {
  ...
  structure: {
    ...
    titlePattern: string;
    /** Character limit per section to dynamically split flat texts */
    splitChars?: number;
...
export interface WordEntry {
  ...
  stem: string;
  /** Offline cached definite article (der, die, el, la, etc.) */
  article?: string;
  ...
  sections: number[];
  /** Part of speech (heuristic: Noun, Verb, Adjective, Other) */
  pos: 'Noun' | 'Verb' | 'Adjective' | 'Other';
  /** Example context sentences from the text with source info */
